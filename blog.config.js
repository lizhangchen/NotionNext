...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lizhang Chen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '救死扶伤的医生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://venous.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '医生, 博客,神经内科, 神经介入,支架,取栓', // 网站关键词 英文逗号隔开
